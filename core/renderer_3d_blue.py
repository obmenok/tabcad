...
def render_tablet_3d(mesh_data, params):
    ...
    # ДИНАМИЧЕСКИЙ ВЫБОР ПРОПОРЦИЙ ОСИ Z
    if shape == "round":
        # Для круга оставляем "сплющенные" красивые пропорции
        ...
        # Для капсул и овалов включаем строгие физические пропорции (aspectmode="data")
        scene_config = dict(
